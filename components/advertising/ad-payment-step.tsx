...
type OnlinePaymentMethod = Extract<CheckoutPaymentMethod, "PAYSTACK" | "FLUTTERWAVE">;

export function AdPaymentStep({
  value,
  onChange,
  onContinue,
  onBack,
  ...
  onChange: (method: OnlinePaymentMethod) => void;
  onContinue: () => void;
  onBack: () => void;
}) {
  const options: { key: OnlinePaymentMethod; label: string; description: string; icon: typeof CreditCard; channels: string[] }[] = [
    {
      key: "PAYSTACK",
      label: "Paystack",
