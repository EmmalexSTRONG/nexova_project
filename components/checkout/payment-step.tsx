...
import type { CheckoutPaymentMethod, FulfillmentMethod } from "@/lib/checkout/types";
...
export function PaymentStep({
  ...
  const options: {
    ...
    },
    {
      ...
      description: fulfillment === "DELIVERY" ? "Pay when your order arrives." : "Pay when you collect your order.",
      icon: Banknote,
    },
  ];
